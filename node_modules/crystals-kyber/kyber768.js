...
KeyGen768 = function() {
    ...
    crypto.getRandomValues(rnd); // ReactNative api cryptographically strong random values
...
Encrypt768 = function(pk) {
    ...
    crypto.getRandomValues(m); // web api cryptographically strong random values
...
function indcpaKeyGen() {
    ...
    let rnd = new Uint8Array(32);
    crypto.getRandomValues(rnd); // web api cryptographically strong random values
